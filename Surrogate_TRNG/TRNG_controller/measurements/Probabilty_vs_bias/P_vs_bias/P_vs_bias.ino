...
#define BUFFER_SIZE 1000       // Circular buffer size
...
float bias_lst[16] = {0, 0.01, 0.03, 0.05, 0.07, 0.09, 0.11, 0.13, 0.15, 0.17, 0.19, 0.21, 0.23, 0.25, 0.27, 0.3};
int idx = 0;
...
void IRAM_ATTR pwm_rising_isr() {
  ...
  if(count == 1500)
  {
    ...
    Serial.println(p); // Print sum of buffer
    Serial.println("bias");
    Serial.println(bias); // Print sum of buffer
    bias = bias_lst[idx];
